    ...
    <div>
      <nav className="p-2 bg-gray-200">
        <ul className="flex gap-2">
          <Link to="/dashboard" className="py-4 px-2 text-sm rounded-sm hover:bg-green-100">
            Dashboard
          </Link>
          <Link
            onClick={showDropDown}
            ref={ref}
            className="relative py-4 px-2 text-sm rounded-sm hover:bg-green-100"
          >
            Projects
            <div
          ...
          <Link
            onClick={showDropDown}
            ref={ref}
            className="flex relative my-auto items-center justify-center h-8 w-8 rounded-full bg-blue-300"
          >
