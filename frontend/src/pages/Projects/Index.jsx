          ...
          <div className="flex flex-col w-1/2 h-96">
            <div className="flex  flex-col h-96">
              ...
              <div className="border py-4">
                ...
                <div className="flex flex-wrap items-center p-2 justify-between rounded-sm">
                  <div className="flex items-center flex-col">
                    <p className="text-sm py-2">Open</p>
                    <div className="rounded-full text-center px-8 md:px-12 bg-red-400">
                      1
                    </div>
                  </div>
                  <div className="flex items-center flex-col">
                    <p className="text-sm py-2">In Progress</p>
                    <div className="rounded-full text-center px-8 md:px-12 bg-blue-400">
                      1
                    </div>
                  </div>
                  <div className="flex items-center flex-col">
                    <p className="text-sm py-2">Closed</p>
                    <div className="rounded-full text-center px-8 md:px-12 bg-green-400">
                      1
                    </div>
                  </div>
                  ...
                  <div className="flex items-center flex-col">
                    ...
                    <div className="rounded-full text-center px-8 md:px-12 bg-yellow-400">
                      1
                    </div>
                  </div>
                </div>
