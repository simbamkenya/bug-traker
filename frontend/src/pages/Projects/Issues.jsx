              ...
              <table class="divide-y divide-green-400 w-full">
                ...
                <tbody class="bg-white divide-y divide-gray-300">
                  {activeProject.issues &&
                    activeProject.issues.map((bug) => (
                      <tr
                        key={bug.id}
                        onClick={() =>
                          navigate(`/projects/${1}/issues/${bug.id}`)
                        }
                        class="whitespace-nowrap hover:bg-green-100"
                      >
                        <td class="px-6 py-2 text-xs text-gray-500">
                          <div className="px-3 text-white flex items-center justify-center py-[3px] bg-red-600 rounded-full">
                            TODO
                          </div>
                        </td>
                        <td class="px-6 py-2">
